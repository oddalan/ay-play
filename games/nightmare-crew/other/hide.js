...
//         cone.position.x = c;
//       }
//       function addChest(delta) {
//       modelLoader.load( './chest/chest.gltf', function ( chest ) {

//       const mixer = new THREE.AnimationMixer( chest );
//       const clips = chest.animations;
...
// const clip = THREE.AnimationClip.findByName( clips, 'Cube.001Action' );
